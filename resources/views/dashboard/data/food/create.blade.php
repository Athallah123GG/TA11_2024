        ...
        <form action="{{ route('food.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group py-2">
                    ...
                    <input type="text" class="form-control" id="nama" placeholder="Nama Makanan" name="nama">
                </div>

                <div class="form-group py-2">
                    <label for="message">Sejarah Makanan</label>
                    <textarea class="form-control" id="sejarah" rows="4" placeholder="Sejarah Makanan"
