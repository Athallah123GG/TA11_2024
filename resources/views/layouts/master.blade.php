...
<body>
    ...
    <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.j s"></script>

    {{-- Font Awesome --}}
    <script src="https://kit.fontawesome.com/b890f0fccf.js" crossorigin="anonymous"></script>
    @yield('page-js')
